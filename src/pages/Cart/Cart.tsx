    ...
    setExtendedPurchases((prev) => {
      ...
      return (
        purchasesInCart?.map((purchase) => {
          const isChoosenPurchaseFormLocation = choosenpurchaseIdFromLocation === purchase._id
          return {
            ...purchase,
            disabled: false,
      ...
      <div className='container'>
        {extendedPurchases.length > 0 ? (
                ...
                {extendedPurchases.length > 0 && (
                  <div className='my-3 rounded-sm bg-white p-5 shadow'>
                    {extendedPurchases?.map((purchase, index) => (
                      <div
                        key={purchase._id}
                        className='text mb-5 grid grid-cols-12 items-center rounded-sm border border-gray-200 bg-white py-5 px-4 text-center text-gray-500 first:mt-5'
                      >
                        <div className='col-span-6'>
                          <div className='flex'>
                            <div className='flex flex-shrink-0 items-center justify-center pr-3'>
          ...
          <div className='text-center'>
            <img src={noproduct} alt='nopurchases' className='mx-auto h-24 w-24' />

            <div className='mt-5 font-bold text-gray-500'>Giỏ hàng của bạn còn trống</div>
            <div className='mt-5 text-center'>
              <Link
                className=' rounded-sm bg-orange px-10 py-2 uppercase text-white transition-all hover:bg-orange/60'
                to={path.home}
              >
                Mua ngay
              </Link>
